...
<body dir="<?= ($_SESSION['site_lang'] == 'arabic')?'rtl':'' ?>" class="hrsale-layout hold-transition sidebar-mini skin-blue <?php echo $fixed_header;?> <?php echo $boxed_wrapper;?> <?php echo $compact_sidebar;?>">
<div class="wrapper"> 
