...
<section class="sidebar">
  ...
  <li class="user-profile treeview">
      <a href="<?php echo site_url('admin/dashboard/');?>">
        <img width="30" height="30" src="<?php echo $cpimg;?>" alt="<?php echo $user_info[0]->first_name. ' '.$user_info[0]->last_name;?>">
      ...
      <ul class="treeview-menu" style="display: none;">
        <li><a href="<?php echo site_url('admin/profile');?>"><?php echo $this->lang->line('header_my_profile');?> </a></li>
        <li><a href="<?php echo site_url('admin/profile?change_password=true');?>"><?php echo $this->lang->line('header_change_password');?></a></a></li>
        <li><a href="<?php echo site_url('admin/auth/lock');?>"><?php echo $this->lang->line('xin_lock_user');?></a></li>
        <?php if(in_array('60',$role_resources_ids)) { ?>
        <li><a href="<?php echo site_url('admin/settings');?>"><?php echo $this->lang->line('left_settings');?></a></li>
        <?php } ?>
        <li><a href="<?php echo site_url('admin/logout');?>"><?php echo $this->lang->line('header_sign_out');?></a></li>
      </ul>
    </li>
    <?php endif;?>
    ...
    <li class="<?php if(!empty($arr_mod['attnd_open']))echo $arr_mod['attnd_open'];?> treeview"> <a href="#"> <i class="fa fa-clock-o"></i> <span><?php echo $this->lang->line('left_timesheet');?></span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
      <ul class="treeview-menu">
        ...
        <li class="sidenav-link <?php if(!empty($arr_mod['attendance_dashboard_active']))echo $arr_mod['attendance_dashboard_active'];?>"> <a href="<?php echo site_url('admin/timesheet/attendance_dashboard');?>"> <i class="fa <?php echo $submenuicon;?>"></i> <?php echo $this->lang->line('hr_timesheet_dashboard_title');?> </a> </li>
        <?php } ?>
